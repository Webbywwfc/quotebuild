...
export default function App() {
  ...
  <div style={{color:"#f472b6",fontSize:"11px",...mo,letterSpacing:"0.08em"}}>📍 INCLUDE LOCATION FOR ACCURATE RATES</div>
  <div style={{color:"#60a5fa",fontSize:"11px",...mo,letterSpacing:"0.08em"}}>✦ MORE DETAIL = BETTER QUOTE</div>
</div>
            </div>
            <div style={{background:"rgba(11,25,46,0.95)",border:"1px solid rgba(96,165,250,0.18)",borderRadius:"12px",padding:"22px",marginBottom:"14px"}}>
